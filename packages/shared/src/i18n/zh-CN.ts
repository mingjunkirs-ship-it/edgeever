...
export const zhCN = {
  ...
  share: {
    title: "分享笔记",
    description: "通过不可猜测的只读链接分享这条笔记，正文会随笔记更新。",
    menu: "分享笔记",
    exportPdf: "导出为 PDF",
    activeBadge: "正在分享",
    link: "分享链接",
    stableLink: "关闭后链接立即失效；重新开启仍使用这个链接。",
    enable: "开启只读分享",
    enableDescription: "任何获得链接的人都可在满足下方条件时查看。",
    password: "访问密码",
    passwordDescription: "可选。开启后访客必须输入至少 8 位密码。",
    passwordExisting: "当前已设置密码；留空保存会保留原密码。",
    passwordKeepPlaceholder: "留空以保留当前密码",
    passwordPlaceholder: "至少 8 个字符",
    expiresAt: "有效期",
    expiresDescription: "留空表示长期有效；到期后链接自动失效。",
    attachments: "允许公开附件",
    attachmentsDescription: "正文图片始终可显示；开启后访客还可下载普通附件。",
    saving: "保存中…",
    save: "保存分享设置",
  },
  publicShare: {
    loading: "正在加载分享笔记…",
    unavailable: "这条分享不存在、已关闭或已过期。",
    passwordTitle: "这条笔记受密码保护",
    passwordDescription: "请输入分享者设置的访问密码。",
