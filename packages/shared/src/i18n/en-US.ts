...
export const enUS = {
  ...
  share: {
    title: "Share note",
    description: "Share this note through an unguessable read-only link. The shared content stays in sync with the note.",
    menu: "Share note",
    exportPdf: "Export as PDF",
    activeBadge: "Shared",
    link: "Share link",
    stableLink: "Closing the share invalidates it immediately; reopening keeps this same link.",
    enable: "Enable read-only sharing",
    enableDescription: "Anyone with the link can view the note when the conditions below are met.",
    password: "Access password",
    passwordDescription: "Optional. Visitors must enter a password of at least 8 characters when enabled.",
    passwordExisting: "A password is already set. Leave the field empty to keep it.",
    passwordKeepPlaceholder: "Leave empty to keep the current password",
    passwordPlaceholder: "At least 8 characters",
    expiresAt: "Expiration",
    expiresDescription: "Leave empty for no expiration. The link stops working automatically after this time.",
    attachments: "Make attachments public",
    attachmentsDescription: "Inline images are always displayed. Enable this to also let visitors download regular attachments.",
    saving: "Saving…",
    save: "Save sharing settings",
  },
  publicShare: {
    loading: "Loading shared note…",
    unavailable: "This share does not exist, has been closed, or has expired.",
    passwordTitle: "This note is password protected",
    passwordDescription: "Enter the access password provided by the owner.",
    ...
    readOnlyLabel: "Read-only share",
    attachments: "Shared attachments",
    readOnly: "Read-only share · Search engine indexing is disabled by default",
  },
  editor: {
